<?php
$viewData['title'] = 'Редактирай форма на обучение';

/** @var \App\Models\EducationTypes $educationType */
$educationType = $model['educationType'];
?>
<form class="form-horizontal" role="search" method="post" action="">
	<fieldset>
	  <legend>Редактиране на форма на обучение</legend>
	  <input type="hidden" name="id" value="<?=$educationType->getId()?>">
